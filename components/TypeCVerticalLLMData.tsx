...
const SLIDE_IMAGES = [
  "https://framerusercontent.com/images/GhKqWw4urSIcFZGZ3kWTXG7c.png?scale-down-to=1024&width=1536&height=1024",
        ...
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight mb-4 text-[#0f2318] dark:text-white overflow-visible">
            ...
            <span className="text-[#046241] dark:text-[#FFB347]">
              <SplitReveal text="Vertical LLM Data" delay={0.32} />
            </span>
          </h1>
