...
const BLOCKS = [
  ...
  },
  {
    ...
    features: ["Auto Crop & De-skew", "Blur Detection", "Foreign Object Detection", "AI Data Extraction"],
  },
  {
    num: "03",
    label: "RESULTS",
    ...
    features: ["Validated accuracy", "Multi-language support", "AI-structured output", "QA certified"],
  },
];
...
function HeroShapes() {
  ...
  return (
    <div ref={heroRef} className="relative overflow-hidden min-h-[320px]" style={{ zIndex: 2 }}>
      {/* Mesh gradient — brand green only */}
      ...
      <Shape src="https://framerusercontent.com/images/LFAxsa4CpX7e4qBI72ijOV2sHg.png?scale-down-to=512"
        style={{ position: "absolute", top: 16, left: 44, width: 155, height: 155, zIndex: 3 }}
        floatOffset={{ y: [-11, 0, -11], r: [0, 2.5, 0] }} extraX={px1} extraY={py1}
        shadow="drop-shadow(0 18px 40px rgba(0,0,0,0.32))" />
      <Shape src="https://framerusercontent.com/images/Tq3lgO9Qy66CFuDaYW99KQ5xoLM.png?scale-down-to=512"
        style={{ position: "absolute", top: 8, right: 50, width: 160, height: 160, zIndex: 3 }}
        floatOffset={{ y: [-8, 0, -8], r: [0, -2, 0] }} extraX={px2} extraY={py2}
        shadow="drop-shadow(0 20px 44px rgba(0,0,0,0.34))" />
      <Shape src="https://framerusercontent.com/images/Es0UNVEZFUO6pTmc3NI38eovew.png?scale-down-to=512"
        style={{ position: "absolute", left: "calc(35% - 95px)", bottom: 30, width: 190, height: 190, zIndex: 4 }}
        floatOffset={{ y: [-8, 0, -8], r: [0, -2, 0] }} extraX={px3} extraY={py3}
...
function HeroCard() {
  return (
    ...
    >
      ...
      {/* Left panel */}
      <div className="p-11 md:p-12 pr-8 md:pr-6 pb-16 flex flex-col justify-between relative z-10 overflow-visible">
        <div>
          {/* Badge */}
          <motion.div
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight mb-4 text-[#0f2318] dark:text-white overflow-visible">
            <SplitReveal text="Type A —" delay={0.22} />
            <br />
            <span className="text-[#046241] dark:text-[#FFB347]">
              <SplitReveal text="Data Servicing" delay={0.32} />
            </span>
          </h1>
          ...
          >
            ...
            extraction, cleaning, labeling, annotation, quality assurance, and formatting.
          </motion.p>
        </div>
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-8 pt-10">
                ...
                {/* Feature chips — white/translucent on green, no per-chip color */}
                <AnimatePresence mode="wait">
...
const ContentBlock: React.FC<ContentBlockProps> = ({ block, isActive, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Active left bar — brand green/amber */}
      <motion.div
